...
const enableMfa = (state: State, method: string) => state.setIn(['mfa', 'settings', method], true);

const disableMfa = (state: State, method: string) => state.setIn(['mfa', 'settings', method], false);
