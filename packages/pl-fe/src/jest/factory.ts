...
const buildGroupRelationship = (
  props: PartialDeep<GroupRelationship> = {},
): GroupRelationship =>
  groupRelationshipSchema.parse(
    Object.assign(
      {
        id: uuidv4(),
      },
...
const buildInstance = (props: PartialDeep<Instance> = {}) =>
  instanceSchema.parse(props);

const buildRelationship = (
  props: PartialDeep<Relationship> = {},
): Relationship =>
