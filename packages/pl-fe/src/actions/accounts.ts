...
const ACCOUNT_REMOVE_FROM_FOLLOWERS_REQUEST =
  'ACCOUNT_REMOVE_FROM_FOLLOWERS_REQUEST' as const;
const ACCOUNT_REMOVE_FROM_FOLLOWERS_SUCCESS =
  'ACCOUNT_REMOVE_FROM_FOLLOWERS_SUCCESS' as const;
const ACCOUNT_REMOVE_FROM_FOLLOWERS_FAIL =
  'ACCOUNT_REMOVE_FROM_FOLLOWERS_FAIL' as const;
...
const FOLLOW_REQUESTS_EXPAND_REQUEST =
  'FOLLOW_REQUESTS_EXPAND_REQUEST' as const;
const FOLLOW_REQUESTS_EXPAND_SUCCESS =
  'FOLLOW_REQUESTS_EXPAND_SUCCESS' as const;
const FOLLOW_REQUESTS_EXPAND_FAIL = 'FOLLOW_REQUESTS_EXPAND_FAIL' as const;

const FOLLOW_REQUEST_AUTHORIZE_REQUEST =
  'FOLLOW_REQUEST_AUTHORIZE_REQUEST' as const;
const FOLLOW_REQUEST_AUTHORIZE_SUCCESS =
  'FOLLOW_REQUEST_AUTHORIZE_SUCCESS' as const;
...
const BIRTHDAY_REMINDERS_FETCH_REQUEST =
  'BIRTHDAY_REMINDERS_FETCH_REQUEST' as const;
const BIRTHDAY_REMINDERS_FETCH_SUCCESS =
  'BIRTHDAY_REMINDERS_FETCH_SUCCESS' as const;
...
const blockAccount =
  (accountId: string) => (dispatch: AppDispatch, getState: () => RootState) => {
    ...
    return getClient(getState)
      .filtering.blockAccount(accountId)
      .then((response) => {
...
const unblockAccount =
  (accountId: string) => (dispatch: AppDispatch, getState: () => RootState) => {
    ...
    return getClient(getState)
      .filtering.unblockAccount(accountId)
      .then((response) => {
        dispatch(importEntities([response], Entities.RELATIONSHIPS));
...
const blockAccountSuccess = (
  ...
  statuses: ImmutableMap<string, MinifiedStatus>,
) => ({
...
const unmuteAccount =
  (accountId: string) => (dispatch: AppDispatch, getState: () => RootState) => {
    ...
    return getClient(getState())
      .filtering.unmuteAccount(accountId)
      .then((response) => {
        dispatch(importEntities([response], Entities.RELATIONSHIPS));
...
const removeFromFollowers =
  (accountId: string) => (dispatch: AppDispatch, getState: () => RootState) => {
    ...
    return getClient(getState())
      .accounts.removeAccountFromFollowers(accountId)
...
const authorizeFollowRequest =
  (accountId: string) => (dispatch: AppDispatch, getState: () => RootState) => {
    ...
    return getClient(getState())
      .myAccount.acceptFollowRequest(accountId)
...
const rejectFollowRequest =
  (accountId: string) => (dispatch: AppDispatch, getState: () => RootState) => {
    ...
    return getClient(getState())
      .myAccount.rejectFollowRequest(accountId)
...
const unpinAccount =
  (accountId: string) => (dispatch: AppDispatch, getState: () => RootState) => {
    ...
    return getClient(getState)
      .accounts.unpinAccount(accountId)
      .then((response) => {
...
const fetchPinnedAccounts =
  (accountId: string) => (dispatch: AppDispatch, getState: () => RootState) => {
    dispatch(fetchPinnedAccountsRequest(accountId));

    return getClient(getState)
      .accounts.getAccountEndorsements(accountId)
      .then((response) => {
...
const fetchPinnedAccountsSuccess = (
  accountId: string,
  accounts: Array<Account>,
  next: string | null,
) => ({
