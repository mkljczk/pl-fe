...
const EVENT_PARTICIPATIONS_FETCH_REQUEST =
  'EVENT_PARTICIPATIONS_FETCH_REQUEST' as const;
const EVENT_PARTICIPATIONS_FETCH_SUCCESS =
  'EVENT_PARTICIPATIONS_FETCH_SUCCESS' as const;
const EVENT_PARTICIPATIONS_FETCH_FAIL =
  'EVENT_PARTICIPATIONS_FETCH_FAIL' as const;

const EVENT_PARTICIPATIONS_EXPAND_REQUEST =
  'EVENT_PARTICIPATIONS_EXPAND_REQUEST' as const;
const EVENT_PARTICIPATIONS_EXPAND_SUCCESS =
  'EVENT_PARTICIPATIONS_EXPAND_SUCCESS' as const;
const EVENT_PARTICIPATIONS_EXPAND_FAIL =
  'EVENT_PARTICIPATIONS_EXPAND_FAIL' as const;

const EVENT_PARTICIPATION_REQUESTS_FETCH_REQUEST =
  'EVENT_PARTICIPATION_REQUESTS_FETCH_REQUEST' as const;
const EVENT_PARTICIPATION_REQUESTS_FETCH_SUCCESS =
  'EVENT_PARTICIPATION_REQUESTS_FETCH_SUCCESS' as const;
const EVENT_PARTICIPATION_REQUESTS_FETCH_FAIL =
  'EVENT_PARTICIPATION_REQUESTS_FETCH_FAIL' as const;

const EVENT_PARTICIPATION_REQUESTS_EXPAND_REQUEST =
  'EVENT_PARTICIPATION_REQUESTS_EXPAND_REQUEST' as const;
const EVENT_PARTICIPATION_REQUESTS_EXPAND_SUCCESS =
  'EVENT_PARTICIPATION_REQUESTS_EXPAND_SUCCESS' as const;
const EVENT_PARTICIPATION_REQUESTS_EXPAND_FAIL =
  'EVENT_PARTICIPATION_REQUESTS_EXPAND_FAIL' as const;

const EVENT_PARTICIPATION_REQUEST_AUTHORIZE_REQUEST =
  'EVENT_PARTICIPATION_REQUEST_AUTHORIZE_REQUEST' as const;
const EVENT_PARTICIPATION_REQUEST_AUTHORIZE_SUCCESS =
  'EVENT_PARTICIPATION_REQUEST_AUTHORIZE_SUCCESS' as const;
const EVENT_PARTICIPATION_REQUEST_AUTHORIZE_FAIL =
  'EVENT_PARTICIPATION_REQUEST_AUTHORIZE_FAIL' as const;

const EVENT_PARTICIPATION_REQUEST_REJECT_REQUEST =
  'EVENT_PARTICIPATION_REQUEST_REJECT_REQUEST' as const;
const EVENT_PARTICIPATION_REQUEST_REJECT_SUCCESS =
  'EVENT_PARTICIPATION_REQUEST_REJECT_SUCCESS' as const;
const EVENT_PARTICIPATION_REQUEST_REJECT_FAIL =
  'EVENT_PARTICIPATION_REQUEST_REJECT_FAIL' as const;
...
const messages = defineMessages({
  ...
  success: {
    id: 'compose_event.submit_success',
    defaultMessage: 'Your event was created',
  },
  editSuccess: {
    id: 'compose_event.edit_success',
    defaultMessage: 'Your event was edited',
  },
...
const fetchEventParticipations =
  (statusId: string) => (dispatch: AppDispatch, getState: () => RootState) => {
    dispatch(fetchEventParticipationsRequest(statusId));

    return getClient(getState)
      .events.getEventParticipations(statusId)
      .then((response) => {
...
const fetchEventParticipationsSuccess = (
  statusId: string,
...
const expandEventParticipations =
  (statusId: string) => (dispatch: AppDispatch, getState: () => RootState) => {
    const next =
      getState().user_lists.event_participations.get(statusId)?.next || null;
...
const expandEventParticipationsSuccess = (
  statusId: string,
  accounts: Array<Account>,
  next: (() => Promise<PaginatedResponse<Account>>) | null,
) => ({
...
const fetchEventParticipationRequests =
  (statusId: string) => (dispatch: AppDispatch, getState: () => RootState) => {
    dispatch(fetchEventParticipationRequestsRequest(statusId));

    return getClient(getState)
      .events.getEventParticipationRequests(statusId)
      .then((response) => {
        dispatch(
          importFetchedAccounts(response.items.map(({ account }) => account)),
        );
        return dispatch(
...
const fetchEventParticipationRequestsSuccess = (
  statusId: string,
...
const fetchEventParticipationRequestsFail = (
  statusId: string,
  error: unknown,
) => ({
...
const expandEventParticipationRequests =
  (statusId: string) => (dispatch: AppDispatch, getState: () => RootState) => {
    const next =
      getState().user_lists.event_participation_requests.get(statusId)?.next ||
      null;
...
const expandEventParticipationRequestsSuccess = (
  statusId: string,
  participations: Array<{
    account: Account;
    participation_message: string;
...
const expandEventParticipationRequestsFail = (
  statusId: string,
  error: unknown,
) => ({
...
const authorizeEventParticipationRequestSuccess = (
  statusId: string,
  accountId: string,
) => ({
...
const authorizeEventParticipationRequestFail = (
  statusId: string,
  accountId: string,
  error: unknown,
) => ({
...
const rejectEventParticipationRequestSuccess = (
  statusId: string,
  accountId: string,
) => ({
...
const rejectEventParticipationRequestFail = (
  statusId: string,
  accountId: string,
  error: unknown,
) => ({
...
type EventsAction = ReturnType<typeof cancelEventCompose> | EventFormSetAction;
