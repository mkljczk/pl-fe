...
describe('shortNumberFormat', () => {
  test('handles non-numbers', () => {
    render(
      <div data-testid='num'>{shortNumberFormat('not-number')}</div>,
      undefined,
      null,
    );
  ...
  test('handles max argument', () => {
    render(
      <div data-testid='num'>{shortNumberFormat(25, 20)}</div>,
      undefined,
      null,
    );
  ...
  test('formats numbers under 1,000', () => {
    render(
      <div data-testid='num'>{shortNumberFormat(555)}</div>,
      undefined,
      null,
    );
  ...
  test('formats numbers under 1,000,000', () => {
    render(
      <div data-testid='num'>{shortNumberFormat(5555)}</div>,
      undefined,
      null,
    );
  ...
  test('formats numbers over 1,000,000', () => {
    render(
      <div data-testid='num'>{shortNumberFormat(5555555)}</div>,
      undefined,
      null,
    );
  ...
  test('formats a multitude of numbers', () => {
    let result = render(
      <div data-testid='num'>{shortNumberFormat(0)}</div>,
      undefined,
      null,
    );
    ...
    result = render(
      <div data-testid='num'>{shortNumberFormat(999)}</div>,
      undefined,
      null,
    );
    ...
    result = render(
      <div data-testid='num'>{shortNumberFormat(1000)}</div>,
      undefined,
      null,
    );
    ...
    result = render(
      <div data-testid='num'>{shortNumberFormat(1001)}</div>,
      undefined,
      null,
    );
    expect(screen.getByTestId('num')).toHaveTextContent('1k');
    ...
    result = render(
      <div data-testid='num'>{shortNumberFormat(1005)}</div>,
      undefined,
      null,
    );
    expect(screen.getByTestId('num')).toHaveTextContent('1k');
    ...
    result = render(
      <div data-testid='num'>{shortNumberFormat(1006)}</div>,
      undefined,
      null,
    );
    expect(screen.getByTestId('num')).toHaveTextContent('1k');
    ...
    result = render(
      <div data-testid='num'>{shortNumberFormat(1010)}</div>,
      undefined,
      null,
    );
    ...
    result = render(
      <div data-testid='num'>{shortNumberFormat(1530)}</div>,
      undefined,
      null,
    );
    ...
    result = render(
      <div data-testid='num'>{shortNumberFormat(10530)}</div>,
      undefined,
      null,
    );
    ...
    result = render(
      <div data-testid='num'>{shortNumberFormat(999500)}</div>,
      undefined,
      null,
    );
    ...
    result = render(
      <div data-testid='num'>{shortNumberFormat(999999)}</div>,
      undefined,
      null,
    );
    expect(screen.getByTestId('num')).toHaveTextContent('999k');
    ...
    result = render(
      <div data-testid='num'>{shortNumberFormat(999499)}</div>,
      undefined,
      null,
    );
    expect(screen.getByTestId('num')).toHaveTextContent('999k');
    ...
    result = render(
      <div data-testid='num'>{shortNumberFormat(1000000)}</div>,
      undefined,
      null,
    );
    ...
    result = render(
      <div data-testid='num'>{shortNumberFormat(3905558)}</div>,
      undefined,
      null,
    );
    ...
    result = render(
      <div data-testid='num'>{shortNumberFormat(1031511)}</div>,
      undefined,
      null,
    );
