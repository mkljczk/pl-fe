...
import type {
  AdminAnnouncement as BaseAdminAnnouncement,
  Announcement as BaseAnnouncement,
} from 'pl-api';

const normalizeAnnouncement = <T extends BaseAnnouncement = BaseAnnouncement>(
  announcement: T,
) => {
...
type AdminAnnouncement = ReturnType<
  typeof normalizeAnnouncement<BaseAdminAnnouncement>
>;
