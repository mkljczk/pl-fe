...
const messages = defineMessages({
  icon: {
    id: 'plfe_config.promo_panel.meta_fields.icon_placeholder',
    defaultMessage: 'Icon',
  },
  label: {
    id: 'plfe_config.promo_panel.meta_fields.label_placeholder',
    defaultMessage: 'Label',
  },
  url: {
    id: 'plfe_config.promo_panel.meta_fields.url_placeholder',
    defaultMessage: 'URL',
  },
});
