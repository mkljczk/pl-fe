...
const messages = defineMessages({
  ...
  changeHeaderDescriptionConfirm: {
    id: 'group.upload_banner.alt.confirm',
    defaultMessage: 'Save',
  },
});
...
const HeaderPicker = React.forwardRef<HTMLInputElement, IMediaInput>(
  (
    ...
    const handleChangeDescriptionClick: React.MouseEventHandler<
      HTMLButtonElement
    > = (e) => {
      e.stopPropagation();
      ...
      openModal('TEXT_FIELD', {
        ...
        placeholder: intl.formatMessage(
          messages.changeHeaderDescriptionPlaceholder,
        ),
