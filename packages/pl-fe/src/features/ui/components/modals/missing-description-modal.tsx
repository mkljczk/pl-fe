...
const messages = defineMessages({
  modalTitle: {
    ...
    defaultMessage:
      'You have not entered a description for all attachments. Continue anyway?',
  },
...
const MissingDescriptionModal: React.FC<
  BaseModalProps & MissingDescriptionModalProps
> = ({ onClose, onContinue }) => {
  const intl = useIntl();
...
export {
  MissingDescriptionModal as default,
  type MissingDescriptionModalProps,
};
