...
import { Emoji, Icon, Text } from 'pl-fe/components/ui';
...
const StatusActionButton = React.forwardRef<
  HTMLButtonElement,
  IStatusActionButton
  ...
  return (
    <button
      ...
      className={clsx(
        ...
        {
          'text-gray-600 hover:text-gray-800 dark:hover:text-white bg-transparent hover:bg-primary-100 dark:hover:bg-primary-800 black:hover:bg-gray-800':
            theme === 'default',
