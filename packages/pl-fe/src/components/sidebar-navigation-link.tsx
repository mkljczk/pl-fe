      ...
      >
        <span
          className={clsx({
            ...
            'bg-primary-50 group-hover:bg-primary-100 dark:bg-slate-700 dark:group-hover:bg-slate-600 black:bg-gray-900 black:group-hover:bg-gray-800':
              !isActive,
        ...
        <Text weight='semibold' theme='inherit'>
          {text}
        </Text>
      </NavLink>
    );
