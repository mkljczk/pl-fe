  ...
  (
    ...
    return (
      <div
        ...
        className={clsx(
          className,
          'pointer-events-auto relative mx-auto flex max-h-[90vh] w-full flex-col overflow-auto rounded-2xl bg-white text-start align-middle text-gray-900 shadow-xl transition-all ease-in-out black:bg-black md:max-h-[80vh] dark:bg-primary-900 dark:text-gray-100',
          widths[width],
          {
        ...
        <div className={clsx('p-6', { 'pt-0': title })}>
          ...
          {confirmationAction && (
            ...
            >
              ...
              <HStack
                space={2}
                className={clsx({ grow: confirmationFullWidth })}
              >
                {secondaryAction && (
                  <Button
                    theme='secondary'
