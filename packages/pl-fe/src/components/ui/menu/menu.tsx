  ...
  return (
    <MenuPopover position={props.position === 'left' ? positionDefault : positionRight}>
      <MenuItems
        ...
        className={
          clsx(className, 'shadow-menu black:bg-black dark:bg-primary-900 rounded-lg bg-white py-1')
        }
        {...filteredProps}
      />
    </MenuPopover>
...
/** Divides menu items. */
const MenuDivider = () => <hr className='black:border-t mx-2 my-1 border-t-2 border-gray-100 dark:border-gray-800' />;
